...
public class ClassMNGDAO {
    ...
    public List<StudentMNG> getListStudentByID(int courseID, int subjectID) throws SQLException {
        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    list.add(new StudentMNG(studentID, code, studentName, birthday, phoneNumber, gender, address, city));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
