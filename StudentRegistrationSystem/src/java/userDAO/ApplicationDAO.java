...
public class ApplicationDAO {
    ...
    public List<Application> getListApplication() throws SQLException {
        ...
        try {
            conn = Util.getConnection();
            if (conn != null) {
                String sql = "SELECT n.ID, n.LecName, n.Type, n.CourseID,n.CourseName, "
