...
public class RefuseApplicationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (type.equals("Report")) {
                ...
                boolean check = dao.refuseReportApplication(application);
                if (check) {
                    request.setAttribute("ERROR_MESSAGE", "Refuse Successfully !!");
                    url = SUCCESS;
                }
            } else {
                ...
                boolean check = dao.refusePresentApplication(application);
                if (check) {
                    request.setAttribute("ERROR_MESSAGE", "Refuse Successfully !!");
                    url = SUCCESS;
                }
