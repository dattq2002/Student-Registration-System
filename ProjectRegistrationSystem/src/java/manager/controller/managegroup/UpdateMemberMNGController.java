...
public class UpdateMemberMNGController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.updateMember(isLeader, memberID);
            if (check) {
                url = SUCCESS;
                request.setAttribute("MESSAGE", "Update Successfully !!");
            }
        } catch (NumberFormatException | SQLException e) {
            log("Error at UpdateMemberMNGController: " + e.toString());
        } finally {
