        ...
        <table border="1">
            ...
            <form action="ManagerController">
                <tr>
                    ...
                    <td>
                        <button>
                            <a href="ManagerController?action=DeleteMember&memberID=<%= dto.getMemberID()%>&groupID=<%= request.getAttribute("GROUP_ID")%>&courseID=<%= request.getAttribute("COURSE_ID")%>&subjectID=<%= request.getAttribute("SUBJECT_ID")%>&groupName=<%= request.getAttribute("GROUP_NAME")%>">Delete</a>
                        </button>
                    </td>
                </tr>
            </form>
