        ...
        <table border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="UserController?action=listSubject&courseID=<%=item.getCourseID()%>&courseName=<%=item.getCourseName()%>&courseCode=<%=item.getCourseCode()%>&sesID=<%=session.getAttribute("SEMESTER_ID") %>">
                            Detail
                        </a>
                    </td>
                </tr>
