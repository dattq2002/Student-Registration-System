package manager.controller.manage.subject;
...
public class getListSubjectControllerMNG extends HttpServlet {
   private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "subjectMNG.jsp";
