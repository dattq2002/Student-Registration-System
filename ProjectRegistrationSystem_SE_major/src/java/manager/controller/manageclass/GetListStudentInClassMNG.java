package manager.controller.manageclass;
...
public class GetListStudentInClassMNG extends HttpServlet {
   
    private static final String ERROR = "listStudentInClassMNG.jsp";
    private static final String SUCCESS = "listStudentInClassMNG.jsp";
