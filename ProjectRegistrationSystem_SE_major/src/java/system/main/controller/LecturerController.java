...
public class LecturerController extends HttpServlet {
    ...
    private static final String LIST_SUBJECT = "getListSubjectControllerMNG";
    private static final String SUBJECT_DETAIL = "GetListSubjectDetailMNG";
    private static final String GROUP_DETAIL = "GetListGroupDetailMNG";
